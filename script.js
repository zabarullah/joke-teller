...
// VoiceRSS Javascript SDK from their website http://www.voicerss.org
const VoiceRSS = {
    speech: function(e) {
        this._validate(e),
        this._request(e)
...
// Passing our Joke to Voice RSS API
function tellMe(joke) {
        VoiceRSS.speech({
        key: 'f0f59e3d713a4e61b8835442a2559cf0',
        src: joke,
        hl: 'en-gb',
        v: 'Linda',
        r: 1, 
...
async function getJokes(){
    ...
    try {
        ...
        //catch errors here
        console.log('error from getJokes function', error)
    }
}
